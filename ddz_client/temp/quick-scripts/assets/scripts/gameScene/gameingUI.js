(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/gameScene/gameingUI.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        _mygolbal2.default.socket.onCanChuCard(function (data) {
            console.log("onCanRobState" + JSON.stringify(data));
            //判断是不是自己能出牌
            if (data == _mygolbal2.default.playerData.accountID) {
                //先清理出牌区域
    ...
    _runactive_pushcard: function _runactive_pushcard() {
        ...
        if (this.cur_index_card < 0) {
            ...
            //this.robUI.active = true
            this.fapai_end = true;
            if (this.rob_player_accountid == _mygolbal2.default.playerData.accountID) {
                this.robUI.active = true;
            }
